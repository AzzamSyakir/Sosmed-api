...
class FollowRequestPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, FollowRequest $followRequest)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, FollowRequest $followRequest)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, FollowRequest $followRequest)
    {
        //
    }
}
